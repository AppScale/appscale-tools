 ...
 * @author: Brett Slatkin (bslatkin@google.com)
   with a few modifications by Chris Bunch (cgb@cs.ucsb.edu)
 */
...
// Compute the amount of CPU time elapsed, in megacycles
function getElapsedCpuString(start, end) {
  var totalTime = end - start;
  var updatedString = totalTime + ' megacycles';
  return updatedString;
}
