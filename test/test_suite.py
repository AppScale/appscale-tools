...
test_cases = [TestAppScale, TestAppScaleDescribeInstances, TestAppScaleResetPassword,
  TestAppScaleRunInstances, TestAppScaleLogger, TestLocalState, TestNodeLayout,
  TestParseArgs, TestRemoteHelper]
